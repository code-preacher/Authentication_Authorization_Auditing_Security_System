                ...
                <div class="container">
                    <div class="navbar-header pull-left">
                        <a class="navbar-brand page-scroll" href="#page-top">
                            ...
                            <span class="brand-logo">AUTHENTICATION, AUTHORIZATION AND ACCOUNTING</span>
                        </a>
                    </div>
            ...
            <header id="intro-carousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <div class="fill" style="background-image:url('images/a.jpg');"></div>
                        <div class="carousel-caption">
                            <h1 class="wow animated slideInDown" style="font-size: 30px;">Welcome To AUTHENTICATION, AUTHORIZATION AND ACCOUNTING SYSTEM!!! </h1>
                    ...
                    <div class="item">
                        ...
                        <div class="fill" style="background-image:url('images/b.jpg');"></div>
                        <div class="carousel-caption">
                            <h1 class="wow animated slideInDown" style="font-size: 30px;">Security at it's Best </span> </h1>
                            <p class="intro-text wow animated slideInUp">Don't be double-minded ....?</p>
                             <a href="login.php" class="btn btn-default btn-lg">Get Started</a>
                        </div>
                        <div class="overlay-detail"></div>
                    </div><!-- /.item -->
                ...
                <div class="mouse"></div>
                            ...
                            <div class="col-md-12 text-center" style="background-color: #000;color: #fff;padding: 10px;font-weight: bolder;">
                                &copy; 2021.AUTHENTICATION, AUTHORIZATION AND ACCOUNTING! All rights reserved.
                            </div><!-- /.col-md-12 -->
